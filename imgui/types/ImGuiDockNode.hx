...
/**
	Read-only state exposed for a Dear ImGui docking node.
**/
enum abstract ImGuiDockNodeState(Int) from Int to Int {
	/**
		The `Unknown` value of `ImGuiDockNodeState`.
	**/
	var Unknown;

	/**
		The `HostWindowHiddenBecauseSingleWindow` value of `ImGuiDockNodeState`.
	**/
	var HostWindowHiddenBecauseSingleWindow;

	/**
		The `HostWindowHiddenBecauseWindowsAreResizing` value of `ImGuiDockNodeState`.
	**/
	var HostWindowHiddenBecauseWindowsAreResizing;

	/**
		The `HostWindowVisible` value of `ImGuiDockNodeState`.
	**/
