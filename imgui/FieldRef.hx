...
/**
	Opaque native pointer to field ref.
**/
...
/**
	Native functions used to construct typed field references.
**/
@:noCompletion
@:hlNative("hlimgui")
class FieldRefNative {
	...
	**/
	...
	/**
		Returns a mutable native reference to `field` on `data`.
	**/
	public static function fieldref_i16(data:Dynamic, field:String):hl.Ref<hl.UI16> {
		return null;
	}
	...
	**/
	...
	/**
		Returns a mutable native reference to `field` on `data`.
	**/
	public static function fieldref_i64(data:Dynamic, field:String):hl.Ref<hl.I64> {
		return null;
	}
	...
	**/
	...
	/**
		Returns a mutable native reference to `field` on `data`.
	**/
	public static function fieldref_f64(data:Dynamic, field:String):hl.Ref<Float> {
		return null;
	}
	...
	/**
		Returns a mutable native reference to `field` on `data`.
	**/
	public static function fieldref_bool(data:Dynamic, field:String):hl.Ref<Bool> {
		return null;
	}
	...
	**/
	...
	/**
		Returns a mutable native reference to `field` on `data`.
	**/
	public static function fieldref_dyn(data:Dynamic, field:String):hl.Ref<Dynamic> {
		return null;
	}
...
/**
	Mutable native reference to a Haxe instance or static field.
**/
@:forward
abstract FieldRef<T>(FieldRefPtr<T>) from FieldRefPtr<T> to FieldRefPtr<T> {
	...
	/**
		Creates a native reference to the instance or static field represented by `e`.
	**/
