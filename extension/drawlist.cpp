...
HL_PRIM void F_NAME(add_image_quad)(ImDrawList* drawlist, ImTextureID user_texture_id, vimvec2* p1, vimvec2* p2, vimvec2* p3, vimvec2* p4, vimvec2* uv1, vimvec2* uv2, vimvec2* uv3, vimvec2* uv4, int* col) {
	drawlist->AddImageQuad(ImTextureRef(user_texture_id), p1, p2, p3, p4, convertVec(uv1, ImVec2(0, 0)), convertVec(uv2, ImVec2(1, 0)), convertVec(uv3, ImVec2(1, 1)), convertVec(uv4, ImVec2(0, 1)), convertPtr(col, IM_COL32_WHITE));
}
