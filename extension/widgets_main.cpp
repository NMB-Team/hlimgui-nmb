...
HL_PRIM void HL_NAME(image_ref)(ImTextureID texture_id, vimvec2* size, vimvec2* uv0, vimvec2* uv1) {
	ImGui::Image(ImTextureRef(texture_id), getImVec2(size), getImVec2(uv0), getImVec2(uv1, ImVec2(1, 1)));
}
...
HL_PRIM void HL_NAME(image_compat)(ImTextureID texture_id, vimvec2* size, vimvec2* uv0, vimvec2* uv1, vimvec4* tint_col, vimvec4* border_col) {
	...
	ImGui::ImageWithBg(ImTextureRef(texture_id), getImVec2(size), getImVec2(uv0), getImVec2(uv1, ImVec2(1, 1)), ImVec4(0, 0, 0, 0), getImVec4(tint_col, ImVec4(1, 1, 1, 1)));
	ImGui::PopStyleColor();
	ImGui::PopStyleVar();
}
...
HL_PRIM void HL_NAME(image_with_bg)(ImTextureID texture_id, vimvec2* size, vimvec2* uv0, vimvec2* uv1, vimvec4* bg_col, vimvec4* tint_col) {
	ImGui::ImageWithBg(ImTextureRef(texture_id), getImVec2(size), getImVec2(uv0), getImVec2(uv1, ImVec2(1, 1)), getImVec4(bg_col), getImVec4(tint_col, ImVec4(1, 1, 1, 1)));
}
...
HL_PRIM bool HL_NAME(image_button)(vstring* str_id, ImTextureID texture_id, vimvec2* size, vimvec2* uv0, vimvec2* uv1, vimvec4* bg_col, vimvec4* tint_col) {
	return ImGui::ImageButton(convertStringNullAsEmpty(str_id), ImTextureRef(texture_id), getImVec2(size), getImVec2(uv0), getImVec2(uv1, ImVec2(1, 1)), getImVec4(bg_col), getImVec4(tint_col, ImVec4(1, 1, 1, 1)));
}
...
HL_PRIM bool HL_NAME(image_button_compat)(ImTextureID texture_id, vimvec2* size, vimvec2* uv0, vimvec2* uv1, int frame_padding, vimvec4* bg_col, vimvec4* tint_col) {
	...
	bool result = ImGui::ImageButton("##image_button", ImTextureRef(texture_id), getImVec2(size), getImVec2(uv0), getImVec2(uv1, ImVec2(1, 1)), getImVec4(bg_col), getImVec4(tint_col, ImVec4(1, 1, 1, 1)));
	ImGui::PopID();
	if (has_frame_padding)
		ImGui::PopStyleVar();
	return result;
